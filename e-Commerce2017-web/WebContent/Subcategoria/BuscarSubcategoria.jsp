...
<div class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="collapse navbar-collapse" id="inner-nav1">
        <ul class="nav navbar-nav">
        	...
        	<% if( cliente.isAdmin() ){ %>
            	<li>
	                <a style="padding-top: 9px; padding-bottom: 9px;" href="<%=request.getContextPath()%>/Subcategoria/FormSubcategoria">
...
<div class="out container collapse" id="form-consulta-avancada" style="">
    <br>
    <form role="form" action="ListaSubcategoria" method="get">
