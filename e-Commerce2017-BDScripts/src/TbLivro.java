...
public class TbLivro implements IScript{
	...
	public String getScript() {
		String str = "CREATE TABLE tb_livro\n"
				...
				+ "INSERT INTO tb_livro  ( ano, titulo, edicao, isbn, sinopse, numeropaginas, autor_id, editora_id , grupopreco_id, dtcadastro , ativo ) "
				+ " VALUES ( 2012, 'Algoritmos - Teoria e Prática', '3ª', '9788535236996', 'Este livro apresenta um texto abrangente sobre o moderno estudo de algoritmos para computadores. É uma obra clássica, cuja primeira edição tornou-se amplamente adotada nas melhores universidades em todo o mundo, bem como padrão de referência para profissionais da área.', 944, 5, 1, 1, '2017-11-07', true);\r\n";
